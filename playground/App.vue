  ...
  <div class="main" bg="[#161618]" h-screen text-white text-center flex justify="center" items-center>
    <div class="body" w-200 mx-auto position-absolute >
      ...
      <div my-6 flex justify="center">
        <div w-20 px-3 py-2 gap-9 text-lg rounded-8 border-none cursor="pointer" bg-red mr-3 flex justify-center items-center @click="replay">replay</div>
        <div w-20 px-3 py-2 gap-9 text-lg rounded-8 border-none cursor="pointer" bg-red mr-3 flex justify-center items-center @click="random">random</div>
